...
export const useImageUrls = () => {
  ...
  return {
    siteImages: {
      ...
      productBenefits: images.productBenefits?.url || "/lovable-uploads/7cd6cae1-e58c-494b-bf7c-8a5a12c1d56e.png",
      productFeatures: images.productFeatures?.url || "/lovable-uploads/80b5514b-753e-4263-8f57-9491d161c817.png",
